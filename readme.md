...
A test measurement for 40 messages, from the point of measurement to arrival in the hive is in !['img/Traveltimes.png'](mg/Traveltimes.png) (measured at 49° latitude).
